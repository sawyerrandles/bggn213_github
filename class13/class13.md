...
2.  Let’s calculate the mean counts per gene for “control” and
    “treated” - then we can compare these :-). Let’s call it
    `control.mean` and `treated.mean`.
...
need to speak ENTREZID so I can check KEGG pathway overlap as KEGG uses
ENTREZ format IDs.
...
```
    ...
    Info: Working in directory /Users/sawyerrandles/Documents/UCSD/Year 1/BGGN213 Bioinformatics F24/BGGN213 R Projects/bggn213_github/class13
